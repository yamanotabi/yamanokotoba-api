namespace :query do
  task :create => :environment do
    ...
    p Word.create(id: "23304512bc65d130f76970f076eae6be", text: '登頂がすべてではない。登山をするということすべてを楽しみたい。', user_name: '竹内洋岳', background_image_url: 'https://yamabluesky.files.wordpress.com/2019/01/mountkinabalu-1024x682.jpg', user_image_url: '', tweet_text: "https://twitter.com/intent/tweet?text=登頂がすべ...&url=https://yamagen.herokuapp.com/words/23304512bc65d130f76970f076eae6be&hashtags=山のことば")
  ...
  task :delete => :environment do
    Word.where(id: '8a53173af583b24ba42148fec6ac3289').delete()
  end
